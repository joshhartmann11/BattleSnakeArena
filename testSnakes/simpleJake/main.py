...
simpleJake is a bare minimum snake without much smarts.  He doesn't hit walls,
doesn't hit other snakes, and tries to get food when he gets low on health. All
of this is achieved with just a few if statements.
"""
import os
import random
import time
